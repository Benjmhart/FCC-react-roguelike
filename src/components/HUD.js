    ...
    <div className="hud-component">
      <div className="left-hud-container">
        <div className="display-bars-container">
          ...
          <DisplayBar
            min={character.EXP}
            max={character.nextLVL}
            color="purple"
            label="EXP"
          />
          <button className="fogbtn" onClick={() => toggleFog()}>
            {fog}
          </button>
        </div>
        <div className="stat-display-container">
          <StatDisplay
            label="STR"
            stat={character.STR}
            trueStat={character.trueSTR}
          />
          <StatDisplay
            label="AGI"
            stat={character.AGI}
            trueStat={character.trueAGI}
          />
          <StatDisplay
            label="WIS"
            stat={character.WIS}
            trueStat={character.trueWIS}
          />
          <StatDisplay
            label="PER"
            stat={character.PER}
            trueStat={character.truePER}
          />
          <StatDisplay
            label="CHA"
            stat={character.CHA}
            trueStat={character.trueCHA}
          />
          <StatDisplay
            label="LUK"
            stat={character.LUK}
            trueStat={character.trueLUK}
          />
