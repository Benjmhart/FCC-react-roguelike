...
const MapItem = ({ disbool, contents, fogofwar }) => {
  ...
  const alsoDisabled =
    !contents.visible && !contents.explored ? "disabled" : "";
  ...
  if (cellContents === "hero") {
    fontAwesome.glyph = <i className="fa fa-user" />;
  }
  if (cellContents === "enemy" && contents.name === "Rat") {
    fontAwesome.glyph = "🐀";
  }
  if (cellContents === "enemy" && contents.name === "Goblin") {
    fontAwesome.glyph = "🦇";
  }
  if (cellContents === "enemy" && contents.name === "Gremlin") {
    fontAwesome.glyph = "😈";
  }
  if (cellContents === "enemy" && contents.name === "Villain") {
    fontAwesome.glyph = "🤵";
  }
  if (cellContents === "enemy" && contents.name === "OwlBear") {
    fontAwesome.glyph = "🐗";
  }
  if (cellContents === "enemy" && contents.name === "Chimera") {
    fontAwesome.glyph = "🦁";
  }
  if (cellContents === "enemy" && contents.name === "Golem") {
    fontAwesome.glyph = "🕴";
  }
  if (cellContents === "enemy" && contents.name === "Centipede") {
    fontAwesome.glyph = "🐛";
  }
  if (cellContents === "enemy" && contents.name === "Drake") {
    fontAwesome.glyph = "🐉";
  }
  ...
  if (fogofwar && alsoDisabled) {
    classnames.push(alsoDisabled);
  }
  if (cellContents) {
    classnames.push(cellContents);
  }
  if (fogofwar && notVis) {
