...
export default function(keycode, floor, heroCoordsArr, weaponAbility) {
	...
	if(keycode === 39 || keycode === 68){pl.attemptedDirection = "East"}
	if(keycode === 38 || keycode === 87){pl.attemptedDirection = "North"}
	if(keycode === 40 || keycode === 83){pl.attemptedDirection = "South"}
	if(pl.attemptedDirection === "West"){pl.destinationContents = floor[heroCoordsArr[0]][heroCoordsArr[1] - 1]}
	if(pl.attemptedDirection === "East"){pl.destinationContents = floor[heroCoordsArr[0]][heroCoordsArr[1] + 1]}
	if(pl.attemptedDirection === "North"){pl.destinationContents = floor[heroCoordsArr[0] - 1][heroCoordsArr[1]]}
	...
	if(pl.success && pl.attemptedDirection === "East"){pl.newHeroCoords =  [heroCoordsArr[0], heroCoordsArr[1] + 1 ]}
