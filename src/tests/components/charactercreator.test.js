...
describe("Character Creator", () => {
	...
	it("displays CharacterStats List items with forms connected to stats on the state.character.stats object ");
	...
	it("calls a start game action when the user completes their character properly")
});